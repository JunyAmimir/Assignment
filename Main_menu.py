...
#while True function used to infinite loop the main menu
    ...
    try:
        ...
        if choice==1:
            ...
            try:
                with open("Admin.txt","r") as f:
                    for line in f:
                        ...
                        if len(parts)==2:
                            aid,pwd=parts
                            if aid.strip().lower()==Admin_id.lower() and pwd.strip()==Admin_password:
                                Admin_id=aid.strip()
            ...
            Student_password=input("Enter your Student Password: ").strip()
            login_successful=False
            try:
                with open("Student.txt","r") as f:
                    for line in f:
                        ...
                        if len(parts)==2:
                            sid,pwd=parts
                            if sid.strip().lower()==Student_id.lower() and pwd.strip()==Student_password:
...
def update_course():
    ...
    try:
        with open('Courses.txt','r') as file:
            for line in file:
                data=line.strip().split(',')
                if len(data)>=3 and data[0]==course_code:
...
def view_result(student_id):
    ...
    try:
        with open("Results.txt","r") as f:
            for line in f:
                parts=line.strip().split(",")
                if len(parts)==3 and parts[0].strip().lower()==student_id.lower():
